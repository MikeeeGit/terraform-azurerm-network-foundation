...
run "hub_two_spokes_and_policy" {
  command = apply
  override_resource {
    target = module.network["hub"].module.vnet.azurerm_virtual_network.main
  ...
  override_resource {
    target = module.network["spoke-app"].module.vnet.azurerm_virtual_network.main
  ...
  override_resource {
    target = module.network["spoke-data"].module.vnet.azurerm_virtual_network.main
